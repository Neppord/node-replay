...
var Replay = (function (_EventEmitter) {
  function Replay(mode) {
    ...
    _get(Object.getPrototypeOf(Replay.prototype), 'constructor', this).call(this);
    this.mode = mode;
    this.chain = new Chain();

    // Localhost servers: pass request to localhost
    this._localhosts = new _Set('localhost', '127.0.0.1', '::1');
    // Pass through requests to these servers
    this._passThrough = new _Set();
    // Dropp connections to these servers
    this._dropped = new _Set();
  ...
  _createClass(Replay, [{
    ...
    value: function passThrough() {
      ...
      try {
        for (var _iterator = _getIterator(hosts), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    value: function drop() {
      ...
      try {
        for (var _iterator2 = _getIterator(hosts), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function localhost() {
      ...
      try {
        for (var _iterator3 = _getIterator(hosts), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
    ...
    value: function reset() {
      ...
      try {
        for (var _iterator4 = _getIterator(hosts), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
